...
import { User, Plus, Search, MoreVertical, Tag as TagIcon, Mail, Phone, Download, X, Trash2, Upload, CheckCircle2, Loader2, Check, ChevronLeft, ChevronRight, Edit } from 'lucide-react'
    ...
    <div className="fade-up" onClick={() => menuId && setMenuId(null)} style={{ paddingBottom: 100 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <Button variant="ghost" size="sm" onClick={() => setShowImporter(true)} disabled={loading || importing}>
            {importing ? <Loader2 size={15} className="animate-spin" /> : <Upload size={15} />} Import Spreadsheet
          </Button>
